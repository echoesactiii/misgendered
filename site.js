$(document).ready(function(){
	...
	$('#form-gender-id').change(function(e){
		...
		}else if($('#form-gender-id').val() == "genderqueer" || $('#form-gender-id').val() == "androgyne" || $('#form-gender-id').val() == "genderless" || $('#form-gender-id').val() == "genderless" || $('#form-gender-id').val() == "neutrois"){
